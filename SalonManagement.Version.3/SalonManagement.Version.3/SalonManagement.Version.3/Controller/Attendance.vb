...
Public Class Attendance
    ...
    Public Sub IsAttendanceUpdated()
        ...
        Try
            IsConnected()
            Dim sql As String = "UPDATE attendance SET employeeID=@0 attendanceDate=@1, attendanceMornIn=@2, attendanceMornOut=@3, attendanceAftIn=@4, attendanceAftOut=@5, Tag=@6 WHERE attendanceID=@6;"
            ServerExecuteSQL(sql, EmployeeID, AttendanceDate, AttendanceMornIn, AttendanceMornOut, AttendanceAftIn, AttendanceAftOut, Tag, AttendanceID)
            Commit()
